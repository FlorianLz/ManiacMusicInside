        ...
        <main class="post blog-post col-lg-8"> 
          <div class="container">
            <div class="post-single">
              <div class="post-thumbnail"><img src="img/articles/top10.jpg" alt="..." class="img-fluid"></div>
              <div class="post-details">
                <div class="post-meta d-flex justify-content-between">
                  <div class="category"><a href="#">MMIssions</a></div>
                </div>
                <h1>MMIssion n°1 : Top 10 des chansons des années 2000<a href="#"><i class="fa fa-bookmark-o"></i></a></h1>
                ...
                <div class="post-body">
                    ...
                    <video controls width="100%" height="auto">
                        ...
                        <source src="/videos/MMIssion1.mp4"
                                type="video/mp4">
                    </video>

                </div>

                <div class="posts-nav d-flex justify-content-between align-items-stretch flex-column flex-md-row"><a href="mmission2.php" class="next-post text-right d-flex align-items-center justify-content-end;" >
                    <div class="text"><strong class="text-primary">Emission suivante </strong>
                      <h6>MMIssion n°2 : Michael Jackson "The king of the pop"</h6>
                    </div>
